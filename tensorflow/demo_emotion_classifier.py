...
mouth_openness_inference = TFInference(model_path = 'models/faceoff_kao_onet_32_lm_12.66-0.31-0.13.hdf5.pb',
                                       input_name = 'import/input_1',
                                       output_names = ['import/output_node0'])
...
while True:
    ...
    print('mouth openness length:', openness_length)
    print('mouth left right length:', left_right_length)
    print('mouth top down length:', top_down_length)


    cv2.putText(rgb_image, 'mouth lr SVR', (10, 9 * 20 + 20), cv2.FONT_HERSHEY_PLAIN, 0.5, (0, 255, 0), 1);
    cv2.rectangle(rgb_image, (130, 9 * 20 + 10), (130 + int(mouth_openness_left_right * 100), (9 + 1) * 20 + 4), (255, 0, 0), -1)
    cv2.putText(rgb_image, 'mouth td SVR', (10, 10 * 20 + 20), cv2.FONT_HERSHEY_PLAIN, 0.5, (0, 255, 0), 1);
    cv2.rectangle(rgb_image, (130, 10 * 20 + 10), (130 + int(mouth_openness_top_down * 100), (10 + 1) * 20 + 4), (255, 0, 0), -1)
    cv2.putText(rgb_image, 'mouth lr DNN', (10, 11 * 20 + 20), cv2.FONT_HERSHEY_PLAIN, 0.5, (0, 255, 0), 1);
    cv2.rectangle(rgb_image, (130, 11 * 20 + 10), (130 + int(openness_length / left_right_length * 100), (11 + 1) * 20 + 4), (255, 0, 0), -1)
    cv2.putText(rgb_image, 'mouth td DNN', (10, 12 * 20 + 20), cv2.FONT_HERSHEY_PLAIN, 0.5, (0, 255, 0), 1);
    cv2.rectangle(rgb_image, (130, 12 * 20 + 10), (130 + int(openness_length / top_down_length * 100), (12 + 1) * 20 + 4), (255, 0, 0), -1)
